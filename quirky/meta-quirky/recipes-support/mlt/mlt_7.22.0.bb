...
# recipetool create -o mlt_7.22.0.bb https://github.com/mltframework/mlt/archive/refs/tags/v7.22.0.tar.gz 

#20220115 bump r6 to r7...  20220131 removed...
#PR = "r${@int(PR_NUM) + 1}"

LICENSE = "GPL-2.0-only & GPL-3.0-only & LGPL-2.1-only & MIT"
...
SRC_URI[sha256sum] = "f4b034e563bcc25ec02e2b66c55ce835b477afda8ecd0bed82c1dd952a3bf172"

#removed:  tcl-native ruby-native
# 20220115 add: frei0r  removed:  python3-native
#20240606 add: xine-lib
DEPENDS = "libx11 swig-native qtbase virtual/libgl \
     ...
     swig lua-native perl-native frei0r xine-lib"
...
#20240606 change  -DMOD_XINE=OFF to ON
EXTRA_OECMAKE = "-DMOD_DECKLINK=OFF -DMOD_JACKRACK=OFF -DMOD_XINE=ON \
