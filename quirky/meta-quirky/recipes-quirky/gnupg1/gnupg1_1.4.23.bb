...
EXTRA_OECONF = " --with-tar=/bin --disable-nls --disable-keyserver-path \
          --disable-mailto --disable-finger --disable-hkp --disable-ldap \
...
#20240528 scarthgap, hmmm, reports "-liconv" missing, though have "--disable-gnupg-iconv"
#run the existing configure...
do_configure() {
 oe_runconf
}
