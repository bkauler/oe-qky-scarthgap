...
#20240105
# | ./configure: line 2674: syntax error near unexpected token `git-directory'
# | ./configure: line 2674: `AX_IS_RELEASE(git-directory)'
...
#20240521 add python3-packaging-native
DEPENDS = "libx11 glib-2.0 gtk+3 libnotify dbus gconf glib-2.0-native autoconf-archive-native python3-packaging-native"

#20240521 add python3native
inherit pkgconfig gettext autotools-brokensep python3native
