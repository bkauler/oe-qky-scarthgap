...
#20240106 do_rootfs error:
# E: Package 'frei0r' has no installation candidate
# packages-split/frei0r is empty.
# ref: https://stackoverflow.com/questions/63937412/yocto-closed-source-library-with-separated-packages-for-library-and-header
SOLIBS = ".so"
FILES_SOLIBSDEV = ""
FILES:${PN} += "${libdir}/frei0r-1/*.so"
