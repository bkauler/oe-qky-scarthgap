...
#SRC_URI:append = " file://vlc-libva-vaapi-fix2.patch"
...
#20240527 patch for libva get compile fail. remove: libva
PACKAGECONFIG:append = " mad a52 jack libass speex vpx qt5 dvdnav \
                         sftp vorbis ogg svg svgdec notify vdpau"

#20240527
PACKAGECONFIG:append = " postproc gstreamer"
